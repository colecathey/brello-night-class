...
namespace Brello.Tests.Models
{
    ...
    public class BoardRepositoryTests
    {
        ...
        {
            var some_context = new Mock<BoardContext>();
            BoardRepository board_repository = new BoardRepository(some_context.Object);
            BrelloList list = new BrelloList();
            Board board = new Board();

            bool actual = board_repository.AddList(board, list);

            Assert.AreEqual(1, board_repository.GetAllLists().Count);
        ...
        public void BoardRepositoryEnsureThereAreZeroLists()
        {
            ...
            Assert.AreEqual(expected, board_repository.GetAllLists(board));
        }
        //These tests are telling us to start looking at
        //How to define CRIS operations for Boards
        ...
        [TestMethod]
        public void BoardRepositoryCanCreateABoard()
        {
